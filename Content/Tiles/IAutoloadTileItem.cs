...
namespace BossForgiveness.Content.Tiles;
...
public class AutoloadTileItemHandler : ModSystem
{
	public static void AutoloadItem(ModTile item) 
		=> ModContent.GetInstance<BossForgiveness>().AddContent(new AutoloadedTileItem(item.Name + "Item", item.Texture + "Item", (IAutoloadTileItem)item));
